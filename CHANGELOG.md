...
No CI changes.
## Other changes
- Merge pull request #64 from SocialBeats/develop

## Full commit history

For full commit history, see [here](https://github.com/SocialBeats/analytics-and-dashboards/compare/v1.0.2...v1.1.0).
